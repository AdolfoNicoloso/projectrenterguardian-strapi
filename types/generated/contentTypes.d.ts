...
export interface ApiAppProfileAppProfile extends Struct.CollectionTypeSchema {
  collectionName: 'app_profiles';
  info: {
    displayName: 'App Profile';
    pluralName: 'app-profiles';
    singularName: 'app-profile';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiInspectionStepInspectionStep
  extends Struct.CollectionTypeSchema {
  collectionName: 'inspection_steps';
  info: {
    displayName: 'Inspection Step';
    pluralName: 'inspection-steps';
    singularName: 'inspection-step';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    >;
    inspection_step_status: Schema.Attribute.Enumeration<
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::inspection-step.inspection-step'
    > &
      Schema.Attribute.Private;
    payload_json: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    step_key: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiInspectionInspection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    created_by_user_id: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    inspection_status: Schema.Attribute.Enumeration<
      ['in_progress', 'completed']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'in_progress'>;
    inspection_type: Schema.Attribute.String & Schema.Attribute.Required;
    inspections_progress: Schema.Attribute.Integer &
      Schema.Attribute.Required &
    ...
    last_step: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::inspection.inspection'
...
export interface ApiPhotoAssignmentPhotoAssignment
  extends Struct.CollectionTypeSchema {
  collectionName: 'photo_assignments';
  info: {
    displayName: 'Photo Space Assignment';
    pluralName: 'photo-assignments';
    singularName: 'photo-assignment';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    confirmed_by_app_profile: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 64;
      }>;
    createdAt: Schema.Attribute.DateTime;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::photo-assignment.photo-assignment'
    > &
      Schema.Attribute.Private;
    ...
    status: Schema.Attribute.Enumeration<['confirmed']> &
      Schema.Attribute.Required &
...
export interface ApiPhotoPhoto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    exif_datetime_original: Schema.Attribute.DateTime;
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    address_free_text: Schema.Attribute.Text & Schema.Attribute.Required;
    app_profile: Schema.Attribute.Relation<
      'manyToOne',
      'api::app-profile.app-profile'
    >;
    ...
    inspections: Schema.Attribute.Relation<
      ...
      'api::inspection.inspection'
    >;
    lease_end_date: Schema.Attribute.Date;
    lease_start_date: Schema.Attribute.Date & Schema.Attribute.Required;
    lease_term: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::property.property'
...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    context_state_code: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 8;
      }>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    disclaimer_version: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 64;
      }>;
    ...
    property: Schema.Attribute.Relation<'manyToOne', 'api::property.property'>;
    publishedAt: Schema.Attribute.DateTime;
    report_type: Schema.Attribute.String & Schema.Attribute.Required;
    snapshot_json: Schema.Attribute.JSON;
...
export interface ApiSpaceSpace extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    custom_space_type: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 255;
      }>;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::space.space'> &
      Schema.Attribute.Private;
    ordinal: Schema.Attribute.Integer;
    property: Schema.Attribute.Relation<'manyToOne', 'api::property.property'>;
    publishedAt: Schema.Attribute.DateTime;
    space_type: Schema.Attribute.Enumeration<
      [
        'living_room',
        'kitchen',
        'hallway',
...
export interface ApiUserPreferenceUserPreference
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    theme_preference: Schema.Attribute.Enumeration<['light', 'dark', 'auto']> &
      Schema.Attribute.Required &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::app-profile.app-profile': ApiAppProfileAppProfile;
      'api::inspection-step.inspection-step': ApiInspectionStepInspectionStep;
      'api::inspection.inspection': ApiInspectionInspection;
      'api::photo-assignment.photo-assignment': ApiPhotoAssignmentPhotoAssignment;
